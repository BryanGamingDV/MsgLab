...
import me.bryangaming.chatlab.spigot.impl.OfflinePlayerWrapperImpl;
...
public class  SpigotModule extends AbstractModule {
    ...
    public void configure() {
        ...
        bindFactory(OfflinePlayerWrapper.class, new TransformingPartFactory<>(new OfflinePlayerPartFactory(),
                OfflinePlayerWrapperImpl::new,
                OfflinePlayerWrapper.class));
