...
public class ChatCommand implements CommandClass {
    ...
    @Command(names = "")
    public boolean mainSubCommand(@SenderAnnotWrapper  PlayerWrapper sender) {
    ...
    @Command(names = "help")
    public boolean helpSubCommand(@SenderAnnotWrapper  PlayerWrapper sender) {
    ...
    @Command(names = "clear")
    public boolean clearSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") @Text String text) {
    ...
    @Command(names = "mute")
    public boolean muteSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") @Text String text) {
    ...
    public boolean unmuteSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") @Text String args) {
    ...
    public boolean cooldownSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") String text) {
    ...
    @Command(names = "color")
    public boolean colorSubCommand(@SenderAnnotWrapper  PlayerWrapper player, @OptArg("") String tag, @OptArg("") String color) {
    ...
    public boolean reloadSubCommand(@SenderAnnotWrapper  PlayerWrapper sender) {
