...
import me.bryangaming.chatlab.common.managers.commands.MsgManager;
import me.bryangaming.chatlab.common.managers.commands.ReplyManager;
...
public class MsgCommand implements CommandClass {
    ...
    public boolean onCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg OfflinePlayer target, @OptArg("") @Text String msg) {
        ...
        PlayerWrapper targetPlayer = target.getPlayer();
