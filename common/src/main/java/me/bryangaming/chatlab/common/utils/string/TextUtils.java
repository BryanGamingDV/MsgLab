...
public class TextUtils {
    ...
    public static String convertText(PlayerWrapper player, String path) {
        path = VariableUtils.replaceAllVariables(player, path);
        return TextUtils.setColor(path);
    }

    public static Component convertTextToComponent(PlayerWrapper player, String path) {
        path = VariableUtils.replaceAllVariables(player, path);
    ...
    public static Component convertTextToComponent(PlayerWrapper player, String path, String message) {
    ...
    public static String convertText(PlayerWrapper player, String path, String message) {
