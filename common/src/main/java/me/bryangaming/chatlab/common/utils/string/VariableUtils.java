...
public class VariableUtils {
    ...
    public static String replaceAllVariables(PlayerWrapper player, String string) {
    ...
    private static String replacePlayerVariables(PlayerWrapper player, String string) {
        return string
    ...
    private static String replaceVaultVariables(PlayerWrapper player, String string) {
    ...
    private static String replaceTags(PlayerWrapper player, String string) {
