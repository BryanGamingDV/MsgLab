...
public class PartyManager {
    ...
    public void createParty(PlayerWrapper playerLeader) {
    ...
    public void deleteParty(PlayerWrapper player) {
    ...
    public void joinParty(PlayerWrapper player, PlayerWrapper leader) {
    ...
    public void invitePlayer(PlayerWrapper player, PlayerWrapper target) {
    ...
    public void removeInvitePlayer(PlayerWrapper player, PlayerWrapper target) {
    ...
    public void promoteToLeader(PlayerWrapper player, PlayerWrapper target) {
    ...
    public void leaveParty(PlayerWrapper player) {
        UserData userData = pluginService.getCache().getUserDatas().get(player.getUniqueId());
    ...
    public void kickPlayer(PlayerWrapper player, PlayerWrapper target) {
        UserData userData = pluginService.getCache().getUserDatas().get(player.getUniqueId());
    ...
    public PartyData getPartyData(PlayerWrapper player) {
        UserData userData = pluginService.getCache().getUserDatas().get(player.getUniqueId());
