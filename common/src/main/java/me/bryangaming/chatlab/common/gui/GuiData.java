package me.bryangaming.chatlab.common.gui;

import me.bryangaming.chatlab.common.api.LegacyHandler;
...
public class GuiData {
    ...
    public void addHead(PlayerWrapper owner, String name, List<String> lore) {
    ...
    public ItemStack createHead(PlayerWrapper owner, String name, List<String> lore) {
