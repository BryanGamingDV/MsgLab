...
public class AnnouncerCommand implements CommandClass {
    ...
    @Command(names = "add")
    public boolean onAddSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") @Text String text) {
    ...
    public boolean onAddLineSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") String id, @OptArg("") @Text String text) {
    ...
    public boolean onRemoveLineSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") String id, @OptArg("") String line) {
    ...
    public boolean onSetLineSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") String id, @OptArg("") String line, @OptArg("") @Text String text) {
    ...
    public boolean onRemoveSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") String id) {
        if (id.isEmpty()) {
            senderManager.sendMessage(sender, messagesFile.getString("error.no-arg")
                    .replace("%usage%", TextUtils.getUsage("announcer", "add", "<text>")));
            senderManager.playSound(sender, SoundEnum.ERROR);
    ...
    @Command(names = "set")
    public boolean onSetSubCommand(@SenderAnnotWrapper  PlayerWrapper sender, @OptArg("") String arg1, @OptArg("") String arg2) {
