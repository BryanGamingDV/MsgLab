...
public class ChatManager {
    ...
    public void clearSubCommand(PlayerWrapper sender, int lines, String world, boolean silent) {
    ...
    public void muteSubCommand(PlayerWrapper sender, int seconds, String channelPath, String worldPath, boolean silent) {
    ...
    public void unmuteSubCommand(String world, String channel, boolean silent) {
        ...
        for (PlayerWrapper onlinePlayer : Bukkit.getOnlinePlayers()) {
            senderManager.sendMessage(onlinePlayer, command.getString("commands.chat.mute.unmute-temporal"));
        }
    }


    public void setCooldown(PlayerWrapper player, int time) {
    ...
    public String replaceTagsVariables(PlayerWrapper player, String message) {
