...
public class MotdCommand implements CommandClass {
    ...
    public boolean mainCommand(@Sender Player sender, @OptArg("1") int page) {
        ...
        if (page <= 0) {
            senderManager.sendMessage(sender, messagesFile.getString("motd.error.negative-number")
        ...
        if (!pageCreator.pageExists(page - 1)) {
            senderManager.sendMessage(sender, messagesFile.getString("motd.error.unknown-page")
        ...
        List<String> motdList = messagesFile.getStringList("motd.list.message");
        ...
        senderManager.sendMessage(sender, messagesFile.getString("motd.list.space"));
    ...
    public boolean addLine(@Sender Player sender, @OptArg("") @Text String text) {
        ...
        if (!senderManager.hasPermission(sender, "motd", "admin")) {
        ...
        senderManager.sendMessage(sender, messagesFile.getString("motd.add-line")
    ...
    public boolean removeLine(@Sender Player sender, @OptArg("1") int page) {
        ...
        if (pageArg.isEmpty()) {
            senderManager.sendMessage(sender, messagesFile.getString("motd.remove-line")
            ...
            try {
                ...
                senderManager.sendMessage(sender, messagesFile.getString("motd.error.unknown-line")
    ...
    public boolean setLine(@Sender Player sender, @OptArg("-1") int page, @OptArg("") @Text String text) {
        ...
        senderManager.sendMessage(sender, messagesFile.getString("motd.set-line")
