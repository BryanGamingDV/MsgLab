...
public class UserData{
    ...
    public String getRepliedBungeePlayer() {
        return repliedBungeePlayer;
    }

    public void setRepliedBungeePlayer(String repliedBungeePlayer) {
        this.repliedBungeePlayer = repliedBungeePlayer;
    }
    ...
    public void resetStats() {
        ...
        if (!repliedBungeePlayer.isEmpty()) repliedBungeePlayer = "";
