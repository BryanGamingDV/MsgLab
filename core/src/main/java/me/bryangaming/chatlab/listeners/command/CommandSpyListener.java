...
public class CommandSpyListener implements Listener {
    ...
    public void onCommandSpy(CommandSpyEvent commandSpyEvent) {
        ...
        List<String> blockedCommands = configFile.getStringList("modules.spymodule.commandspy.blocked-commands");
        ...
        String commandSpyFormat = messagesFile.getString("commandspy.format")
